  ...
  return (
    <div className="">
      ...
      <section className="flex flex-col w-full">
        ...
        <p className="max-w-2xl mt-12  font-medium  text-gray-600 dark:text-gray-300 leading-relaxed ml-[25%] ">
        ...
        <div className="mt-10 flex items-center gap-2 justify-end mr-5">
