  ...
  return (
    <div className="px-4 md:px-10 xl:px-20 ">
      ...
      <div className="flex flex-col md:flex-row items-center justify-center   lg:mt-10">
        ...
        <div className="pt-4 md:pt-0 md:fixed md:left-10 xl:left-20 md:top-20 lg:top-24 md:w-[28%] xl:w-[22%] md:h-[calc(100vh-8rem)] lg:h-[calc(100vh-10rem)] mt-20 md:mt-0 md:mr-2 ">
          <LeftFixedSection></LeftFixedSection>
        </div>
        {/* Home Content */}
        <div className="md:ml-[36%] xl:ml-[30%]  w-full">
          
          <section id="home" className="mt-16 md:mt-20 lg:mt-14 scroll-mt-26">
