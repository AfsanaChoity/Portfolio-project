    ...
    return (
        <div className=''>
            ...
            <div>
                ...
                <h2 className="text-3xl md:text-4xl lg:text-6xl  mt-8 font-medium text-gray-800 dark:text-white italic ml-[10%] ">
                    Sparks<span className="text-yellow-500 "> Innovation</span>
                </h2>
            </div>
            <div className='max-w-3xl mt-12 bg-base-200 dark:bg-[#26393a] p-5  rounded-xl dark:border dark:border-[#234748] shadow-lg border border-gray-300'>
                ...
                <div>
                    ...
                    <div className='mt-4'>
                        ...
                        <div>
                            ...
                            <p className='font-medium  text-gray-600 dark:text-gray-300 '>C, Python, Machine Learning algorithms</p>

                        </div>
                        
                        <div className='mt-6'>
                            <h3  className='text-xl  font-medium text-gray-900 dark:text-white mb-2'>Application Software:</h3>
                            <p className='font-medium  text-gray-600 dark:text-gray-300'>Origin, MultiSim, Proteus, CASTEP, MS Office, LATEX</p>
                        </div>
